...
local Utility = {}
local Objects = {}
function SuperSploit:DraggingEnabled(frame, parent)
...
local Name = "SuperSploitHub.JSON"
...
local LibName = 'SuperSploitHub'

function SuperSploit:ToggleUI()
...
function SuperSploit.CreateLib(SuperSploitName, themeList)
    ...
    local selectedTab 
    SuperSploitName = SuperSploitName or "Library"
    table.insert(SuperSploit, SuperSploitName)
    for i,v in pairs(game.CoreGui:GetChildren()) do
        if v:IsA("ScreenGui") and v.Name == SuperSploitName then
            v:Destroy()
        end
    end
    ...
    SuperSploit:DraggingEnabled(MainHeader, Main)
    ...
    close.ZIndex = 1
    close.Image = "http://www.roblox.com/asset/?id=8167926955"
    ...
    function SuperSploit:ChangeColor(prope,color)
